      ...
      <div className="overflow-x-auto pr-8">
        <table className="w-full table-auto border-collapse bg-white shadow-lg rounded-lg">
          ...
          <tbody>
            {IncomeData.length === 0 && (
              <tr>
                <td colSpan={5} className="text-center py-4 text-gray-400">No income transactions found.</td>
              </tr>
            )}
            {IncomeData.map((transaction, index) => (
              <tr className="border-b last:border-none hover:bg-gray-50 transition-colors align-middle" key={index}>
                ...
                <td className="p-4 text-right text-green-500 font-semibold align-middle">
                ...
                <td className="p-4 text-right align-middle">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      navigate('/add-income', { state: { income: transaction } })
                    }}
                  >
                    Update
                  </button>
      ...
      {deleteId && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
          <div className="bg-white rounded-lg p-6 shadow-lg w-80">
            ...
            <p className="mb-6">Are you sure you want to delete this income?</p>
